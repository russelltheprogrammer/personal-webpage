    ...
    return ( 
     ...
     <div id="footer">
        <div className="container-fluid">
            ...
            <li>
                <a className="footer-link" href="https://twitter.com/RussellTheProg1" target="_blank" rel="noreferrer noopener">
            ...
            <li>
                <a className="footer-link" href="https://www.hackerrank.com/russelltheprogr1?hr_r=1" target="_blank" rel="noreferrer noopener">
